...
class Projects extends CMS
{
  ...
  public static function AddProject($title, $body, $deadline, $doc)
  {
    ...
    $announcementData = Announcements::AddAnnouncement(
      ...
      'Έχει ανακοινωθεί μια νέα εργασία με τίτλο: ' . $title . '. Παρακαλώ ελέγξτε την σελίδα των εργασιών για περισσότερες πληροφορίες. Η προθεσμία παράδοσης είναι: ' . $deadline . '.',
      1,
      $inserted_project->id
    );
